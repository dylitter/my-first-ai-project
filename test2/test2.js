 ...
 * @property {number} count - Purchased quantity.
 * @property {string} originPrice - Original price shown in the UI.
 * @property {string} salePrice - Sale price shown in the UI.
 */

/**
 * @typedef {object} CouponInfo
 * @property {string} name - Coupon display name.
 * @property {number} count - Total coupon count in the order.
 */

/**
 * @typedef {object} Order
 * @property {OrderGoods} goods - Purchased goods information.
 * @property {CouponInfo} coupon - Coupon summary information.
 * @property {string} payAmount - Amount paid by the user.
 * @property {string} refundAmount - Amount refunded to the user.
 * @property {number} usedTimes - Number of coupons already used.
 * @property {number} leftTimes - Number of coupons still available.
 * @property {string} createdAt - Order creation time.
 * @property {string} storeName - Store where the order was created.
 * @property {string} orderNo - Order number used for display and copy.
 */
 ...
 * @property {string} amount - Amount displayed for the current status.
...
/**
 * Mock order data used by the payment result page.
 *
 * @type {Order}
 */
const ORDER = {
...
Page({
   ...
   */
  onLoad(query = {}) {
    this.setStatus(query.status || 'success');
    this.setDetailRows();
  },
